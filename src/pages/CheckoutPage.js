...
const CheckoutPage = () => {
  ...
  const handleOrder= (e) => {
    ...
    {const order ={
      items,totalAmount , totalItems , user , paymentMethod , selectedAddress , status : 'pending'}
      dispatch(createOrderAsync(order))

  }
     //TODO : redirect to order-success page
     //TODO : clear cart
     //TODO : on server change stock number
  }
  return (
    <>
    ...
    <div className="mx-auto max-w-7xl  mt-12 px-4 sm:px-6 lg:px-8 ">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className='bg-white px-5 py-10 mt-12' onSubmit={ handleSubmit ((data) => {
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto max-w-7xl  mt-12 px-4 sm:px-6 lg:px-8 bg-white">
            <h1 className='text-4xl font-bold tracking-light text-gray-900  my-12 text-center'>Cart</h1>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div className="text-gray-500">
                            ...
                            <label htmlFor="quantity" className="inline-block mr-5 text-sm font-medium leading-6 text-gray-900">
                              Qty                </label>
